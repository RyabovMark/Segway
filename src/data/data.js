...
import NinebotKickScooterZingE8Pink
  from './images/Ninebot eKickScooter Zing E8 Pink-PhotoRoom.png'
import NinebotKickScooterZingE10
  from './images//Ninebot eKickScooter Zing E10-PhotoRoom.png'
import NinebotKickScooterA6 from './images/Ninebot KickScooter A6-PhotoRoom.png'
import NinebotKickScooterC10
  from './images//Ninebot KickScooter C10-PhotoRoom.png'
import NinebotKickScooterE22
  from './images/Ninebot KickScooter E22-PhotoRoom.png'
import NinebotKickScooterE25
  from './images//Ninebot KickScooter E25-PhotoRoom.png'
import NinebotKickScooterE45
  from './images//Ninebot KickScooter E45-PhotoRoom.png'
import NinebotKickScooterES1
  from './images//Ninebot KickScooter ES1-PhotoRoom.png'
import NinebotKickScooterES1L
  from './images//Ninebot KickScooter ES1L-PhotoRoom.png'
import NinebotKickScooterES2
  from './images//Ninebot KickScooter ES2-PhotoRoom.png'
import NinebotKickScooterES4
  from './images//Ninebot KickScooter ES4-PhotoRoom.png'
import NinebotKickScooterF30
  from './images//Ninebot KickScooter F30-PhotoRoom.png'
import NinebotKickScooterF40A
  from './images//Ninebot KickScooter F40A-PhotoRoom.png'
import NinebotKickScooterMAXG30LP
  from './images//Ninebot KickScooter MAX G30LP-PhotoRoom.png'
import NinebotKickScooterZingE12
  from './images//Ninebot KickScooter Zing E12-PhotoRoom.png'
...
import accessories1
  from "../data/images/accessories/Ninebot Engine Speaker.png";
import accessories2 from "../data/images/accessories/Extension Rod.png";
import accessories3
  from "../data/images/accessories/Segway Protective Gear Set.png";
import accessories4
  from "../data/images/accessories/Ninebot Leisure Backpack.png";
import accessories5
  from "../data/images/accessories/Segway External Battery.png";
...
export const accessories = [
  {
    ...
    description: 'The built-in engine sound simulation system can simulate the realistic engine roar based on the vehicles accelerator, brake, speed, and other signals',
    cost: 149.99,
...
export const description = [
  {
    ...
    text: 'The basic warranty is 1 year. You can also extend the warranty up' +
      ' to 4 years',
    ...
    text: 'If you have any difficulties with your kickscooter, our' +
    ...
    text: 'With a range of up to 40 miles, the longest range on the market, and ' +
...
export const reviewsData = [
  {
    ...
    review: 'Et harum quidem rerum facilis est et expedita distinctio, quia voluptas sit, aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos, qui ratione voluptatem sequi nesciunt, neque porro quisquam est, qui dolorem eum fugiat, quo voluptas nulla pariatur. At vero eos et accusamus et iusto odio dignissimos ducimus, nam libero tempore, cum soluta nobis est eligendi optio, cumque nihil impedit, quo minus id, quod maxime placeat, ut et voluptates repudiandae sint et molestiae non recusandae. Ut enim ad minima veniam, qui blanditiis praesentium voluptatum deleniti atque corrupti, quos dolores et quas molestias excepturi sint, qui dolorem eum fugiat,...',
    date: '19.09.2021',
    id: 10
  }, {
    writer: 'Shu Hua',
    avatar: ShuHua,
    review: 'Nemo enim ipsam voluptatem, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur. Duis aute irure dolor in reprehenderit in voluptate, nam libero tempore, cum soluta nobis est eligendi optio, cumque nihil impedit, quo minus id, quod maxime placeat, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, quis nostrum exercitationem ullam corporis suscipit laboriosam, qui dolorem ipsum, quia dolor sit, amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt, ut labore et dolore magnam aliquam quaerat voluptatem. Duis aute irure dolor in reprehenderit in...',
    date: '20.12.2021',
    id: 11
  },
]
