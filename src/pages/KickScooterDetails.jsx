  ...
  return (
    <Box sx={{ flex: "1 0 auto", marginY: "30px" }}>
      ...
      <Box width="80%" mx="auto" color="text.primary" mb="30px">
        ...
        <Typography textAlign="justify">
          Scooter is equipped with the newly upgraded Pneumatic tires, which
          provides an elevated driving experience with the combination of
          comfort and shock absorption features, designed to increase riding
          safety.
        </Typography>
        <Typography variant="h6" lineHeight="2.5" textTransform="capitalize">
        ...
        <Typography textAlign="justify">
          Connect the {findItem.name} with Segway-Ninebot app through Bluetooth
          to check your riding speed and remaining battery. You can also upgrade
          the scooter firmware over-the-air and monitor riding data, which
        ...
        <Typography textAlign="justify">
          ...
          ride on the road, the stronger brushless direct current motor delivers
          a fast and sturdy riding experience.
        </Typography>
      </Box>
